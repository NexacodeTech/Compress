...
$compress->compress('files/100mb_low.pdf', OutputTypeEnum::FILE, 'files/100mb_low.pdf');


$compress->setQuality(QualityEnum::MEDIUM);
$compress->compress('files/100mb_low.pdf', OutputTypeEnum::FILE, 'files/100mb_medium.pdf');


$compress->setQuality(QualityEnum::HIGH);
$compress->compress('files/100mb_low.pdf', OutputTypeEnum::FILE, 'files/100mb_high.pdf');


$compress->setQuality(QualityEnum::VERY_HIGH);
$compress->compress('files/100mb_low.pdf', OutputTypeEnum::FILE, 'files/100mb_very_high.pdf');

$compress->setQuality(QualityEnum::MAXIMUM);
$compress->compress('files/100mb_low.pdf', OutputTypeEnum::FILE, 'files/100mb_maximum.pdf');
